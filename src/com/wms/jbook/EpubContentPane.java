 ...
 * @author stemenm
 */
public class EpubContentPane extends JPanel implements NavigationEventListener, HyperlinkListener
{
    
	private static final long serialVersionUID = -5322988066178102320L;

	private static final Logger log = LoggerFactory.getLogger(EpubContentPane.class);
	...
	public EpubContentPane(Navigator navigator) {
			    ...
			    if (notches < 0) {
					...
					if (viewPosition.getY() - increment < 0) {
						if (gotoPreviousPage) {
							...
							EpubContentPane.this.navigator.gotoPreviousSpineSection(-1, EpubContentPane.this);
						} else {
					...
					if (viewPosition.getY() + viewportHeight + increment > scrollMax) {
						if (gotoNextPage) {
							gotoNextPage = false;
							EpubContentPane.this.navigator.gotoNextSpineSection(EpubContentPane.this);
						} else {
							gotoNextPage = true;
		...
		editorPane.addKeyListener(new KeyListener() {
			...
			public void keyPressed(KeyEvent keyEvent) {
				if (keyEvent.getKeyCode() == KeyEvent.VK_RIGHT) {
					navigator.gotoNextSpineSection(EpubContentPane.this);
				} else if (keyEvent.getKeyCode() == KeyEvent.VK_LEFT) {
					navigator.gotoPreviousSpineSection(EpubContentPane.this);
//				} else if (keyEvent.getKeyCode() == KeyEvent.VK_UP) {
//					EpubContentPane.this.gotoPreviousPage();
				} else if (keyEvent.getKeyCode() == KeyEvent.VK_SPACE) {
//					|| (keyEvent.getKeyCode() == KeyEvent.VK_DOWN)) {
					EpubContentPane.this.gotoNextPage();
				}
			}
		});
		return editorPane;
