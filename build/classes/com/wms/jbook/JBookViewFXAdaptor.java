...
// */
//class FxChapter extends JPanel {
//
//    private String chapterName;
//    private String chapterContents;
//    private EpubContentPane contentPane;
//
//    public FxChapter(Navigator navigator, String name) {
...
//
//public class JBookViewFXAdaptor  {
//
//    public JBookViewFXAdaptor(GridPane mainPane) {
...
//    private static Logger log = LoggerFactory.getLogger(JBookViewFXAdaptor.class);
...
//
//        JBookKey testKey;
//        testKey = this.localLibrarian.addBook(file, this.coverDim.width, this.coverDim.height);
//        JBook testJBook = this.localLibrarian.getBook(testKey);
//
//        this.showJBook(testJBook);
//    }
...
//
//        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.wms.jbook.JBookApp.class).getContext().getResourceMap(JBookViewFXAdaptor.class);
...
//
//        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.wms.jbook.JBookApp.class).getContext().getActionMap(JBookViewFXAdaptor.class, this);
...
//    private final DefaultListModel<String> chapterListModel = new DefaultListModel<>();
//}
